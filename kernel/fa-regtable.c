...
const struct zfa_field_desc zfad_regs[] = {
	...
	/* UTC */
	[ZFA_UTC_SECONDS_H] =		{0x00, 0x000000FF, 1},
	[ZFA_UTC_SECONDS_L] =		{0x04, ~0x0, 0},
	[ZFA_UTC_COARSE] =		{0x08, 0x0FFFFFFF, 1},
	[ZFA_UTC_TRIG_PROG_SECONDS_H] = {0x0C, 0x000000FF, 1},
	[ZFA_UTC_TRIG_PROG_SECONDS_L] = {0x10, ~0x0, 0},
	[ZFA_UTC_TRIG_PROG_COARSE] =	{0x14, 0x0FFFFFFF, 1},
	[ZFA_UTC_TRIG_SECONDS_H] =	{0x18, 0x000000FF, 1},
	[ZFA_UTC_TRIG_SECONDS_L] =	{0x1C, ~0x0, 0},
	[ZFA_UTC_TRIG_COARSE] =	{0x20, 0x0FFFFFFF, 1},
	[ZFA_UTC_ACQ_START_SECONDS_H] = {0x24, 0x000000FF, 1},
	[ZFA_UTC_ACQ_START_SECONDS_L] = {0x28, ~0x0, 0},
	[ZFA_UTC_ACQ_START_COARSE] =	{0x2C, 0x0FFFFFFF, 1},
	[ZFA_UTC_ACQ_STOP_SECONDS_H] =	{0x30, 0x000000FF, 1},
	[ZFA_UTC_ACQ_STOP_SECONDS_L] =	{0x34, ~0x0, 0},
	[ZFA_UTC_ACQ_STOP_COARSE] =	{0x38, 0x0FFFFFFF, 1},
	[ZFA_UTC_ACQ_END_SECONDS_H] =	{0x3C, 0x000000FF, 1},
	[ZFA_UTC_ACQ_END_SECONDS_L] =	{0x40, ~0x0, 0},
	[ZFA_UTC_ACQ_END_COARSE] =	{0x44, 0x0FFFFFFF, 1},
};
